...
c     **** uses standard intgral formulas for gto's
     ...
     + rrr,rrrval,radpsi,value(1000),totalval,
     + Q,qrad,qslope
...
c          write(6,*)'scale ',scale
      ...
      do 40 ir=1,nbasis
           do 50 jc=1,ir    
                ...
                call qromb(Q,alpha(ir),
     +          alpha(jc),norm(ir),norm(jc),qrad,
     +          r1,qslope)
                vint(ir,jc)=dcmplx(r1,0.0d+00)
                vint(jc,ir)=dcmplx(r1,0.0d+00)

                core(ir,jc)=tint(ir,jc)+vint(ir,jc)
                core(jc,ir)=tint(jc,ir)+vint(jc,ir)
...
c      do 71 ir=1,nbasis
c         do 72 jc=1,ir
c                r1=dreal(core(ir,jc))
c               core(ir,jc)=dcmplx(r1,0.0d+00)
c                core(jc,ir)=core(ir,jc)
c72       continue
c71       continue
      ...
      do 86 iii = 1,nbasis
            ...
            do 712 kstep=1,500    
                ...
                do 713 kbas=1,nbasis
                    radpsi =rrr*norm(kbas)*dexp(-alpha(kbas)*rrr)
...
712         continue
            ...
            do 715 kstep=1,500
               rrrval=rrrval+0.10
               value(kstep)=value(kstep)*10.0/totalval
...
CU    USES polint,trapzd
      ...
      g = a1+a2
      r5=n1*n2
      if(r5.ge.1.0d+19)r5=1.0d+29  
      if(r5.le.1.0d-19)r5=1.0d-29  


      r3= r5*PI*8.0d+00/105.0d+00
      r4 = 1.00d+00/(2.0d+00*g*g)
