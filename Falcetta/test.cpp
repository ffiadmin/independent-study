/**********************************************************************
 * This program calculates the energies for 1 electron in the field 
 * an arbitrary arrangement of point charges.
 *
...
//      read in minalp, maxalp, and step
	...
	double t1,t2,t3,t4;
  	...
  	for(int ii=0; ii<nnuc; ii++){
        ...
        for (double scale=1.0; scale<1.05; scale=scale+0.05){
